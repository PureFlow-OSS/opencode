...
throw "No signing configuration found. Set AZURE_KEYVAULT_URL/AZURE_KEYVAULT_CLIENT_ID/AZURE_KEYVAULT_CLIENT_SECRET/AZURE_KEYVAULT_TENANT_ID/AZURE_KEYVAULT_CERT, or AZURE_TRUSTED_SIGNING_ENDPOINT/AZURE_TRUSTED_SIGNING_ACCOUNT_NAME/AZURE_TRUSTED_SIGNING_CERTIFICATE_PROFILE."
