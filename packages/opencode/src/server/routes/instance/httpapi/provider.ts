  ...
  Effect.gen(function* () {
    ...
    const authorize = Effect.fn("ProviderHttpApi.authorize")(function* (ctx: {
      ...
      const result = yield* svc
        ...
        .pipe(Effect.catch(() => Effect.fail(invalidRequest("Provider OAuth authorization request was rejected."))))
      if (!result) return yield* invalidRequest("Provider OAuth authorization request returned no authorization data.")
      return result
    })
    ...
    const callback = Effect.fn("ProviderHttpApi.callback")(function* (ctx: {
      ...
      yield* svc
        ...
        .pipe(Effect.catch(() => Effect.fail(invalidRequest("Provider OAuth callback payload was rejected."))))
      return true
    })
