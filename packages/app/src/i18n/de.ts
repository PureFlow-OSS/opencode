...
export const dict = {
  ...
  "settings.updates.section.reset": "Zurücksetzen",
  ...
  "settings.updates.reset.title": "OpenCode-Daten zurücksetzen",
  "settings.updates.reset.description": "Sessions, Cache, Registry-Einträge und lokale OpenCode-Daten löschen",
  "settings.updates.reset.action": "Jetzt zurücksetzen",
  "settings.updates.reset.confirm":
    "Möchtest du wirklich alle Sessions, Cache, Registry-Einträge und lokalen OpenCode-Daten löschen?",
  "settings.updates.reset.success.title": "Zurücksetzen gestartet",
  "settings.updates.reset.success.description": "Das Zurücksetzen der OpenCode-Daten wurde gestartet.",
  "settings.updates.reset.failed.title": "Zurücksetzen fehlgeschlagen",
  ...
  "settings.feedback.description": "Internes Feedback zu OpenCode",
  "settings.feedback.category.general": "Allgemein",
  "settings.feedback.category.bug": "Fehlerbericht",
  "settings.feedback.category.idea": "Idee",
  "settings.feedback.field.text.label": "Nachricht",
  "settings.feedback.field.text.description": "Beschreiben Sie, was passiert ist oder was Sie sich wünschen.",
  "settings.feedback.field.text.placeholder": "Was ist passiert?",
  "settings.feedback.field.text.counter": "Noch {{count}} Zeichen verfügbar",
  "settings.feedback.field.attachments.label": "Anhänge",
  "settings.feedback.field.attachments.empty": "Keine Anhänge ausgewählt.",
  "settings.feedback.field.attachments.count": "{{count}} Anhang/Anhänge ausgewählt",
  "settings.feedback.action.send": "Feedback senden",
  "settings.feedback.toast.sent.title": "Feedback gesendet",
  "settings.feedback.toast.sent.description": "Danke. Ihr Feedback wurde an den Feedback-Server übermittelt.",
