...
export const dict = {
  ...
  "settings.tab.betaFeedback": "Beta-Feedback",
  "settings.feedback.title": "Feedback",
  "settings.feedback.description": "Teile uns mit, was funktioniert hat, was nicht funktioniert oder verbessert werden kann.",
  "settings.feedback.category.general": "Allgemeines Feedback",
  "settings.feedback.category.bug": "Fehler melden",
  "settings.feedback.category.idea": "Funktionsvorschlag",
  "settings.feedback.field.attachments.label": "Anhänge",
  "settings.feedback.field.attachments.count": "{{count}} Datei(en) ausgewählt",
  "settings.feedback.field.attachments.empty": "Keine Dateien ausgewählt.",
  "settings.feedback.field.text.label": "Nachricht",
  "settings.feedback.field.text.description": "Beschreibe dein Feedback. Screenshots und Logs können oben angehängt werden.",
  "settings.feedback.field.text.placeholder": "Was ist passiert?",
  "settings.feedback.field.text.counter": "Noch {{count}} Zeichen",
  "settings.feedback.action.send": "Feedback senden",
  "settings.feedback.toast.sent.title": "Feedback gesendet",
  "settings.feedback.toast.sent.description": "Danke, dass du OpenCode verbesserst.",
