export const dict = {
  ...
  "settings.feedback.category.general": "General",
  "settings.feedback.category.bug": "Bug report",
  "settings.feedback.category.idea": "Idea",
  "settings.feedback.field.text.label": "Message",
  "settings.feedback.field.text.description": "Describe what you ran into or what you would like to see.",
  ...
  "settings.feedback.field.attachments.empty": "No attachments selected.",
  "settings.feedback.field.attachments.count": "{{count}} attachment(s) selected",
  "settings.feedback.action.send": "Send feedback",
  "settings.feedback.toast.sent.title": "Feedback sent",
  "settings.feedback.toast.sent.description": "Thanks. Your feedback was delivered to the feedback server.",
