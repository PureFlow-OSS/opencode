export const dict = {
  ...
  "settings.feedback.description": "Tell us what worked, what did not, or what could be improved.",
  "settings.feedback.category.general": "General feedback",
  "settings.feedback.category.bug": "Bug report",
  "settings.feedback.category.idea": "Feature idea",
  "settings.feedback.field.attachments.label": "Attachments",
  "settings.feedback.field.attachments.count": "{{count}} file(s) selected",
  "settings.feedback.field.attachments.empty": "No files selected.",
  "settings.feedback.field.text.label": "Message",
  "settings.feedback.field.text.description": "Describe your feedback. Screenshots and logs can be attached above.",
  "settings.feedback.field.text.placeholder": "Tell us what happened...",
  "settings.feedback.field.text.counter": "{{count}} characters left",
  "settings.feedback.action.send": "Send feedback",
  "settings.feedback.toast.sent.title": "Feedback sent",
  "settings.feedback.toast.sent.description": "Thank you for helping improve OpenCode.",
